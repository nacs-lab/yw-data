...
for No in No_list:
    ...
    for i in range(steps):
        ...
        state_evolve = (H_V+func_Omega((i*dt))*H_O+expramp(i*dt,Crit_delta,tau1,Crit_t,Delta_fin,tau2,ramp_time,Delta_ini)*H_D).evolve(state_evolve, t=dt)
    data['z'].append(measure_z(state_evolve))
    data['zz'].append(measure_zz(state_evolve))
